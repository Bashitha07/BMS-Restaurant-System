...
import { CalendarIcon, ClockIcon, UsersIcon, TrashIcon, AlertTriangle } from 'lucide-react'
...
const Reservations = () => {
  ...
  // Mock reservations data - limited view for regular users
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-sm text-orange-700 mt-1">
                  You can view and manage your own reservations. Full reservation details and customer information are only available to administrators.
                </p>
              </div>
            </div>
          </div>
