...
const ManagerDashboard = () => {
  ...
  const updateOrderStatus = async (orderId, newStatus) => {
    try {
      setUpdating(true);
      await managerService.updateOrderStatus(orderId, newStatus);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Oversee all restaurant operations and order management</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatPrice(orders.filter(o => o.status === 'DELIVERED').reduce((sum, order) => sum + (order.totalAmount || 0), 0))}
                </p>
              </div>
            </div>
          </div>
