...
(NOW(), 'PENDING', 2750.00, 2500.00, 200.00, 50.00, 'CASH_ON_DELIVERY', '123 Main Street, City Center', '071-123-4567', 'Extra cheese please', 'DELIVERY', DATE_ADD(NOW(), INTERVAL 30 MINUTE), NULL, NOW(), 2)
